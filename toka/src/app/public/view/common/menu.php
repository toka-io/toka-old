<nav class="navbar navbar-default" role="navigation">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a id="alpha-test-info" href="#" class="toka-menu-item"><img src="/assets/images/icons/info.svg" class="menu-icon" />Chat server is being updated!! Aka toka will not operate normally at the moment. The application will be available again tomorrow 2/24/15~     -Arc</a></li>
      <!-- <li class="dropdown">
